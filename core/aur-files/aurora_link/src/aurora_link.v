...
//*********************************Main Body of Code**********************************
    ...
    aurora_link_PHASE_ALIGN  aurora_link_lane_phase_align_i
    (
    ...
    defparam aurora_link_aurora_lane_0_i.EXTEND_WATCHDOGS = EXTEND_WATCHDOGS;
    aurora_link_AURORA_LANE aurora_link_aurora_lane_0_i
    (
        // MGT Interface
...
/*
    aurora_link_PHASE_ALIGN  aurora_link_lane_0_phase_align_i
    (
        // Aurora Lane Interface
        .ENA_COMMA_ALIGN(ena_comma_align_i),
...
*/
    ...
    defparam aurora_link_global_logic_i.EXTEND_WATCHDOGS = EXTEND_WATCHDOGS;
    aurora_link_GLOBAL_LOGIC    aurora_link_global_logic_i
    (
        // MGT Interface
    ...
    aurora_link_TX_LL aurora_link_tx_ll_i
    (
    ...
    aurora_link_RX_LL   aurora_link_rx_ll_i
    (
        // LocalLink PDU Interface
        .RX_D(RX_D),
        .RX_REM(RX_REM),
